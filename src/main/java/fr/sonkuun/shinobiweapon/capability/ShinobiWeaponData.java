...
public class ShinobiWeaponData {
	...
	public UUID getMinatoKunaiUUID() {
		return minatoKunaiUUID;
	}

	public void setMinatoKunaiUUID(UUID minatoKunaiUUID) {
		this.minatoKunaiUUID = minatoKunaiUUID;
	}
	...
	public static final String MINATO_KUNAI_UUID_NBT = "minato_kunai_uuid";
	...
	public static class ShinobiWeaponDataNBTStorage implements Capability.IStorage<ShinobiWeaponData> {
		...
		public INBT writeNBT(Capability<ShinobiWeaponData> capability, ShinobiWeaponData instance, Direction side) {
			...
			tag.putString(MINATO_KUNAI_UUID_NBT, instance.minatoKunaiUUID.toString());
		...
		public void readNBT(Capability<ShinobiWeaponData> capability, ShinobiWeaponData instance, Direction side,
			...
			if(nbt instanceof CompoundNBT) {
				...
				if(tag.getString(MINATO_KUNAI_UUID_NBT) != null) {
					instance.setMinatoKunaiUUID(UUID.fromString(tag.getString(MINATO_KUNAI_UUID_NBT)));
				}
			}
		}
