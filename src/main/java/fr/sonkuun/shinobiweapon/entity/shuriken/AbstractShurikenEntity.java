...
public abstract class AbstractShurikenEntity extends ProjectileItemEntity implements IEntityAdditionalSpawnData {
	...
	public AbstractShurikenEntity(EntityType<? extends ProjectileItemEntity> type, World world,
	...
	public AbstractShurikenEntity(EntityType<? extends ProjectileItemEntity> type, LivingEntity thrower, World world) {
	 ...
	 * on the ThrowableEntity class. This is too much for a shuriken.
	 */
